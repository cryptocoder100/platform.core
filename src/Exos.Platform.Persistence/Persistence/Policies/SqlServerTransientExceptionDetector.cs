...
namespace Exos.Platform.Persistence.Policies
{
    ...
    {
        /// <summary>
        /// Evaluate if the exception has a transient error code.
        /// </summary>
        /// <param name="ex">Exception to Evaluate<see cref="Exception"/>.</param>
        /// <returns>True if exception has a transient error.</returns>
            ...
            if (ex is SqlException sqlException)
            {
                foreach (SqlError err in sqlException.Errors)
                {
                    switch (err.Number)
                    {
                        ...
                        // Transaction was aborted as database is moved to read-only mode. This is a temporary situation and please retry the operation.
                        case 40540:
