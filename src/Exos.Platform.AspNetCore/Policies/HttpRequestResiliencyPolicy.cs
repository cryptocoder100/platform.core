namespace Exos.Platform.AspNetCore.Resiliency.Policies
{
    ...
    /// <summary>
    /// A HTTP request resiliency policy.
    /// </summary>
    public class HttpRequestResiliencyPolicy : IHttpRequestResiliencyPolicy
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HttpRequestResiliencyPolicy"/> class.
        /// </summary>
        /// <exception cref="ArgumentNullException"> Thrown when one or more required arguments are null.</exception>
        /// <param name="options"> Options to configure HttpRequestResiliencyPolicy.</param>
        /// <param name="logger"> The logger.</param>
        /// <param name="telemetryClient"> The telemetry client.</param>
        public HttpRequestResiliencyPolicy(
